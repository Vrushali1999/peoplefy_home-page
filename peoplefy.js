(function() {
    ...
    function scrollToIdInit() {
      $('.js-scroll-to-id').click( function() {
        $('.js-scroll-to-id').removeClass('is-pin-active')
        $(this).addClass('is-pin-active');
        let secId =  this.getAttribute("data-id");
        $('.js-tab-menu-content').removeClass('active_section');
        $('#'+secId).addClass('active_section');
      })
    ...
    //         document.querySelector('.js-tab-menu-content').classList.remove('active_section');
    //         el.classList.add('is-pin-active');
    //         document.getElementById(el.getAttribute("data-id")).classList.add('active_section');
    //     })
    //   });
    }
    scrollToIdInit();
